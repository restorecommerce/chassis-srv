...
https://coveralls.io/github/restorecommerce/chassis-srv?branch=master[image:http://img.shields.io/coveralls/github/restorecommerce/chassis-srv/master.svg?style=flat-square[Coverage Status]]
