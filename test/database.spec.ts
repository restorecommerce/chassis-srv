...
function testProvider(providerCfg) {
  ...
  describe('upsert', () => {
    it('should insert a new document if it does not exist with upsert operation', async function checkUpsert() {
      const newDoc = {
        id: '/test/testupsert',
        name: 'test',
      };
    ...
    it('should update existing document with upsert operation', async function checkUpsert() {
      const newDoc = {
        id: '/test/testupsert',
        name: 'changedAgain',
      };
  ...
  describe('inserting a document', () => {
    ...
    it('should return an error response when inserting same document twice', async function insertDocument() {
  ...
  describe('update', () => {
    ...
    it('should return error response when updating document which does not exist', async function checkUpdate() {
  ...
  describe('delete', () => {
    it('should delete document and also return a response for missing / invalid doc ID', async function checkDelete() {
