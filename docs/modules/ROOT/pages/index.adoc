...
* a base implementation for a link:./command-interface.adoc[command-interface]
...
For more details about all implemented operations please refer link:./command-interface.adoc[command-interface].
